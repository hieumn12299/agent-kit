...
prdPurpose: '.agent/skills/akit-create-prd/data/prd-purpose.md'
---
...
- IF A: Invoke the `akit-advanced-elicitation` skill, then return to discussion
- IF P: Invoke the `akit-party-mode` skill, then return to discussion
