# akit-onboard — ### Step 7: Retrieve Context
...
```
➡️ Proceed to Step 8? [Y/n]

When confirmed, I will read: .agent/skills/akit-onboard/steps/step-08-*.md
```

**⛔ STOP HERE. Do NOT proceed to Step 8 until user confirms.**
