# akit-onboard — ### Step 6: End Session
...
When confirmed, I will read: .agent/skills/akit-onboard/steps/step-07-*.md
```

**⛔ STOP HERE. Do NOT proceed to Step 7 until user confirms.**
