# akit-create-graph — ### Step 5: Register as CLI Graph
...
When confirmed, I will read: .agent/skills/akit-create-graph/steps/step-06-*.md
```

**⛔ STOP HERE. Do NOT proceed to Step 6 until user confirms.**
