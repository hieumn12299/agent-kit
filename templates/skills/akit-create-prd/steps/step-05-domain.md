...
#### Menu Handling Logic:
- IF A: Invoke the `akit-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `akit-party-mode` skill, and when finished redisplay the menu
