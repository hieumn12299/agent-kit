...
- When 'A' selected: Invoke the `akit-advanced-elicitation` skill
- When 'P' selected: Invoke the `akit-party-mode` skill
...
- Invoke the `akit-advanced-elicitation` skill with specific decision categories
...
- Invoke the `akit-party-mode` skill with architectural decisions context
